...
const REQUIRED_CONTENT = [
  {
    ...
    patterns: [
      ...
      ['opened flat file watcher', /watches the active import-free document/],
      ['scene_open tool', /\bscene_open\b/],
      ['scene_render_file tool', /\bscene_render_file\b/],
      ['scene_flatten_file tool', /scene_flatten_file/],
  ...
  },
  {
    ...
    patterns: [
      ...
      ['scene_flatten_file workflow', /scene_flatten_file/],
