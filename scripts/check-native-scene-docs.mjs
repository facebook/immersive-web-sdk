...
const REQUIRED_CONTENT = [
  {
    ...
    patterns: [
      ...
      ['managed workspace route', /\/__iwsdk\/workspace\b/],
      ['scene JSON extension', /\.iwsdk\.scene\.json\b/],
      ['public scenes path', /public\/scenes\b/],
      ['in-memory scene load API', /\bloadSceneDocument\b/],
      ['workspace_get_state tool', /\bworkspace_get_state\b/],
      ['workspace_set_view tool', /\bworkspace_set_view\b/],
      ['scene_list_files tool', /\bscene_list_files\b/],
      ['scene_open tool', /\bscene_open\b/],
      ['scene_create tool', /\bscene_create\b/],
      ['scene_list_assets tool', /\bscene_list_assets\b/],
      ['scene_add_node tool', /\bscene_add_node\b/],
      ['scene_place_on tool', /\bscene_place_on\b/],
      ['scene_look_at tool', /\bscene_look_at\b/],
      ['scene_set_camera tool', /\bscene_set_camera\b/],
      ['scene_screenshot tool', /\bscene_screenshot\b/],
      ['scene_validate tool', /\bscene_validate\b/],
      ['scene_save tool', /\bscene_save\b/],
  ...
  },
  {
    ...
    patterns: [
      ...
      ['old editor project mention', /Meta Spatial project directories\b/],
      ['old GLXF output mention', /public\/glxf\/Composition\.glxf\b/],
      ['new scene JSON path', /public\/scenes\/<name>\.iwsdk\.scene\.json\b/],
      ['managed workspace route', /\/__iwsdk\/workspace\b/],
      ['shared asset catalog', /shared asset catalog\b/],
      ['scene_list_assets workflow', /\bscene_list_assets\b/],
      ['scene_list_files workflow', /\bscene_list_files\b/],
      ['scene_open workflow', /\bscene_open\b/],
      ['scene_place_on workflow', /\bscene_place_on\b/],
      ['scene_look_at workflow', /\bscene_look_at\b/],
      ['scene_validate workflow', /\bscene_validate\b/],
      ['scene_save workflow', /\bscene_save\b/],
      ['top camera check', /\btop\b/],
      ['front camera check', /\bfront\b/],
      ['side camera check', /\bside\b/],
      ['quarter camera check', /\bquarter\b/],
      ['orbit camera check', /\borbit\b/],
    ],
  },
  {
  ...
  },
  {
    ...
    patterns: [
      ['scene tool guidance', /\bscene_list_assets\b[\s\S]*\bscene_save\b/],
      [
        'multi-angle screenshot guidance',
